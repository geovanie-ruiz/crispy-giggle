        ...
        >
          <WrapperWithQuery>
            <div className="flex flex-col min-h-screen">
              <Nav />
              <div className="flex-grow font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center p-8 pb-20 gap-16 sm:p-20 transition-colors duration-300">
                {children}
              </div>
              <Footer />
            </div>
